...
export class Datepicker extends DewsFormComponent {
    constructor() {
        ...
        this.readonly = false;
        this.required = false;
        this.min = `${new Date().getFullYear() - 100}${('0' + (new Date().getMonth() + 1)).slice(-2)}${('0' + new Date().getDate()).slice(-2)}`;
        this.max = `${new Date().getFullYear() + 100}${('0' + (new Date().getMonth() + 1)).slice(-2)}${('0' + new Date().getDate()).slice(-2)}`;
        this.spinner = false;
        this.visible = false;
            ...
            for (let j = 1; j <= 7; j++) {
              ...
              <span></span>
                  ...
                  <span>${count}</span>
                        ...
                        else if (this._setMonth === todayMonth + 1 &&
                  ...
                  >
                    <span>${count}</span>
                                ...
                                _dateView.push(html `<div class="day weekend select" data-value="${count}" @click="${this._dayClickHandler}">
                    <span>${count}</span>
                  </div>`);
                            }
                        }
    ...
    _monthPickerView(y) {
        ...
        for (let i = 1; i <= 12; i++) {
            if (todayYear === this._setYear && i === this._setMonth) {
                _mountView.push(html `<div class="month select" data-value="${i}" @click="${this._monthClickHandler}"><span>${i}</span></div>`);
            }
            else if (todayYear > Number((_a = this.max) === null || _a === void 0 ? void 0 : _a.slice(0, 4)) ||
                (todayYear === Number((_b = this.max) === null || _b === void 0 ? void 0 : _b.slice(0, 4)) && i > Number((_c = this.max) === null || _c === void 0 ? void 0 : _c.slice(4, 6)))) {
                _mountView.push(html `<div class="month month-disabled" data-value="${i}" @click="${this._monthClickHandler}">
            <span>${i}</span>
          </div>`);
            }
            else if (todayYear < Number((_d = this.min) === null || _d === void 0 ? void 0 : _d.slice(0, 4)) ||
                (todayYear === Number((_e = this.min) === null || _e === void 0 ? void 0 : _e.slice(0, 4)) && i < Number((_f = this.min) === null || _f === void 0 ? void 0 : _f.slice(4, 6)))) {
                _mountView.push(html `<div class="month month-disabled" data-value="${i}" @click="${this._monthClickHandler}">
            <span>${i}</span>
          </div>`);
            }
        ...
        for (let i = 0; todayYearStart + i <= todayYearEnd; i++) {
            ...
            <span>${todayYearStart + i}</span>
                ...
                if (todayYearStart + i === this._setYear) {
                    _yearView.push(html `<div class="year select" data-value="${todayYearStart + i}" @click="${this._yearClickHandler}">
              <span>${todayYearStart + i}</span>
            </div>`);
                }
                else if (todayYearStart + i > Number((_a = this.max) === null || _a === void 0 ? void 0 : _a.slice(0, 4)) ||
    ...
    _spinnerPickerView(y, m) {
        ...
        for (let i = 0; yearMin + i <= yearMax; i++) {
            ...
            <button>${yearMin + i}</button>
                ...
                this.$spinnerYear.push(html `<li data-value="${yearMin + i}" data-index="${i}"><button>${yearMin + i}</button></li>`);
            }
            // }
        }
        for (let j = 1; j <= 12; j++) {
            // 달 생성
            if (yearMin !== year || (yearMin === year && j >= Number((_a = this.min) === null || _a === void 0 ? void 0 : _a.slice(4, 6)))) {
                if (yearMax !== year || (yearMax === year && j <= Number((_b = this.max) === null || _b === void 0 ? void 0 : _b.slice(4, 6)))) {
                    if (j === this.toMonth + 1) {
                        this.$spinnerMonth.push(html ` <li class="today" data-value="${j}" data-index="${j}"><button>${j}</button></li> `);
                    }
                    else {
        ...
        for (let k = 1; k <= lastDate; k++) {
            // 일 생성
            if (yearMin !== year ||
                (yearMin === year && month + 1 >= Number((_c = this.min) === null || _c === void 0 ? void 0 : _c.slice(4, 6)) && k >= Number((_d = this.min) === null || _d === void 0 ? void 0 : _d.slice(6, 8)))) {
                if (yearMax !== year ||
                    (yearMax === year && month + 1 <= Number((_e = this.max) === null || _e === void 0 ? void 0 : _e.slice(4, 6)) && k <= Number((_f = this.max) === null || _f === void 0 ? void 0 : _f.slice(6, 8)))) {
                    if (k === this.toDay) {
                        this.$spinnerDay.push(html ` <li class="today" data-value="${k}" data-index="${k}"><button>${k}</button></li>`);
                    }
                    else {
    ...
    _inputHandler(e) {
        ...
        if (e.data !== null) {
            ...
            if (cursor === 4) {
                ...
                this._value = `${this._setYear}-${this._setMonth >= 10 ? this._setMonth : '0' + this._setMonth}-${this._setDay < 10 ? '0' + this._setDay : this._setDay}`;
            }
    ...
    _afterAnimation() {
        ...
        if (Math.abs(this._count + this._touchMoveX) <= ($el.clientWidth / 3) * 2) {
            ...
            this._count = 0;
            $el.style.transform = `translate3d(${-Math.abs(this.shadowRoot.querySelector('.drawer-layout').querySelector('.calendar-flip-wrap').clientWidth / 3)}px, 0px, 0px)`;
            this._afterViewSet();
    ...
    _modeViewChange() {
        if (this._mode === 'day') {
            ...
            this._modeView = `${(this._viewYear / 10) * 10 - (this._viewYear % 10)}-${(this._viewYear / 10) * 10 + 9 - (this._viewYear % 10)}`;
        }
    }
    //  다음버튼 HTML 템플릿 설정
    _afterViewSet() {
    ...
    _removeClickHandler() {
        ...
        if (!this.spinner) {
            ...
            this.shadowRoot.querySelector('.input').value = '____-__-__';
            this.shadowRoot.querySelector('.drawer-layout').querySelectorAll('.select').forEach($el => {
    ...
    _touchStartHandler(e) {
        if (!this.spinner) {
            ...
            this._touchStartSpinnerPoint = Math.abs(Number(e.currentTarget.children[0].parentElement.parentElement.style.transform.split('(')[1].split('px')[0]));
    ...
    _spinnerYearSelect() {
        var _a;
        const $drawer = this.shadowRoot.querySelector('.drawer-layout');
        $drawer.querySelector('.moving-list.year').children[this._setYear - Number((_a = this.min) === null || _a === void 0 ? void 0 : _a.slice(0, 4))].classList.add('select');
    }
    ...
    _spinnerYearChange() {
        ...
        $el.querySelector('.year').children[0].style.transform = `translateY(-${(this._setYear - Number((_a = this.min) === null || _a === void 0 ? void 0 : _a.slice(0, 4))) * 35}px)`;
    }
    ...
    updated(_changedProperties) {
        ...
        if (this.spinner && !this._removeCheck) {
            this.shadowRoot.querySelector('.drawer-layout').querySelectorAll('.clear').forEach($el => {
        ...
        if (this.spinner) {
            ...
            this.shadowRoot.querySelector('.drawer-layout').querySelector('.year')
                .children[0].style.transform = `translateY(-${(this._setYear - Number((_a = this.min) === null || _a === void 0 ? void 0 : _a.slice(0, 4))) * 35}px)`;
                ...
                for (let i = 0; i < month.children.length; i++) {
                    if (Number(month.children.item(i).dataset.value) === this._setMonth) {
                        this.shadowRoot.querySelector('.drawer-layout').querySelector('.month')
                            .children[0].style.transform = `translateY(-${i * 35}px)`;
                    }
                }
            }
            else {
                this.shadowRoot.querySelector('.drawer-layout').querySelector('.month')
                    .children[0].style.transform = `translateY(-${(this._setMonth - 1) * 35}px)`;
            }
            if (day.children.length !== this.lastDay[this._setMonth - 1]) {
                ...
                if (day.children.length < nowPosition) {
                    this.shadowRoot.querySelector('.drawer-layout').querySelector('.day')
                        .children[0].style.transform = `translateY(-${(day.children.length - 1) * 35}px)`;
                    ...
                    this.shadowRoot.querySelector('.drawer-layout').querySelector('.day')
                        .children[0].style.transform = `translateY(-${(this._setDay - 1) * 35}px)`;
                }
            }
        }
    }
...
__decorate([
    property({ type: Boolean }),
    __metadata("design:type", Object)
], Datepicker.prototype, "spinner", void 0);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Object)
], Datepicker.prototype, "hdDisabled", void 0);
__decorate([
    internalProperty(),
    __metadata("design:type", Object)
], Datepicker.prototype, "_value", void 0);
__decorate([
    internalProperty(),
    __metadata("design:type", Object)
], Datepicker.prototype, "active", void 0);
__decorate([
    internalProperty(),
    __metadata("design:type", Object)
], Datepicker.prototype, "_beforeView", void 0);
__decorate([
    internalProperty(),
    __metadata("design:type", Object)
], Datepicker.prototype, "_nowView", void 0);
__decorate([
    internalProperty(),
    __metadata("design:type", Object)
], Datepicker.prototype, "_afterView", void 0);
__decorate([
    internalProperty(),
    __metadata("design:type", Object)
], Datepicker.prototype, "_modeView", void 0);
__decorate([
    internalProperty(),
    __metadata("design:type", String)
], Datepicker.prototype, "_mode", void 0);
__decorate([
    internalProperty(),
    __metadata("design:type", Array)
], Datepicker.prototype, "$spinnerYear", void 0);
__decorate([
    internalProperty(),
    __metadata("design:type", Array)
], Datepicker.prototype, "$spinnerMonth", void 0);
__decorate([
    internalProperty(),
    __metadata("design:type", Array)
], Datepicker.prototype, "$spinnerDay", void 0);
