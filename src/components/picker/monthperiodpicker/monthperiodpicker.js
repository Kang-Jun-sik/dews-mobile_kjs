...
export class Monthperiodpicker extends DewsFormComponent {
  constructor() {
    super(...arguments);
    this.disabled = false;
    this.readonly = false;
  ...
  _inputHandler(e) {
    ...
    if (cursor === 17 && e.data !== null) {
      if (Number(e.target.value.slice(0, 4)) > Number(e.target.value.slice(13, 17))) {
    ...
    if (cursor === 20 && e.data !== null) {
      if (
        Number(e.target.value.slice(0, 4)) === Number(e.target.value.slice(13, 17)) &&
        Number(e.target.value.slice(5, 7)) > Number(e.target.value.slice(18, 20))
      ) {
        e.target.value = value.slice(0, 10) + ' ~ ' + value.slice(0, 10);
        change();
      }
    ...
    if (cursor === 23 && e.data !== null) {
      if (
        Number(e.target.value.slice(0, 4)) === Number(e.target.value.slice(13, 17)) &&
        Number(e.target.value.slice(5, 7)) === Number(e.target.value.slice(18, 20)) &&
        Number(e.target.value.slice(8, 10)) > Number(e.target.value.slice(21, 23))
      ) {
        e.target.value = value.slice(0, 10) + ' ~ ' + value.slice(0, 10);
        change();
      }
  ...
  _removeClickHandler() {
    ...
    (_b = (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelectorAll('.select')) === null ||
    _b === void 0
      ? void 0
      : _b.forEach($select => {
          $select.classList.remove('select');
        });
    (_c = this.shadowRoot.querySelector('.period-month.period .select-start')) === null || _c === void 0
      ? void 0
      : _c.classList.remove('select-start');
    (_d = this.shadowRoot.querySelector('.period-month.period .select-end')) === null || _d === void 0
      ? void 0
      : _d.classList.remove('select-end');
    (_e = this.shadowRoot.querySelectorAll('.period-month.period .select-period')) === null || _e === void 0
      ? void 0
      : _e.forEach($period => {
  ...
  _dayViewChange(y, m) {
    ...
    (_b = (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelector('.select')) === null ||
    _b === void 0
      ? void 0
      : _b.classList.remove('select');
    (_d = (_c = this.shadowRoot) === null || _c === void 0 ? void 0 : _c.querySelector('.select-start')) === null ||
    _d === void 0
      ? void 0
      : _d.classList.remove('select-start');
    (_f = (_e = this.shadowRoot) === null || _e === void 0 ? void 0 : _e.querySelector('.select-end')) === null ||
    _f === void 0
      ? void 0
      : _f.classList.remove('select-end');
    (_h = (_g = this.shadowRoot) === null || _g === void 0 ? void 0 : _g.querySelectorAll('.select-period')) === null ||
    _h === void 0
      ? void 0
      : _h.forEach($period => {
          $period.classList.remove('select-period');
  ...
  _nowClickHandler() {
    ...
    (_a = this.shadowRoot.querySelector('.selected')) === null || _a === void 0
      ? void 0
  ...
  _optionBtnClickHandler(e) {
    ...
    if ($el.classList.contains('select')) {
      ...
      (_a = this.shadowRoot.querySelector('.period-month.period .select-start')) === null || _a === void 0
        ? void 0
        : _a.classList.remove('select-start');
      (_b = this.shadowRoot.querySelector('.period-month.period .select-end')) === null || _b === void 0
        ? void 0
        : _b.classList.remove('select-end');
      (_c = this.shadowRoot.querySelectorAll('.period-month.period .select-period')) === null || _c === void 0
        ? void 0
        : _c.forEach($period => {
            $period.classList.remove('select-period');
          });
  ...
  _clickHandler(e) {
    ...
    if (!this.disabled && !this.readonly) {
      ...
      window.scrollTo(
        0,
        window.pageYOffset +
          ((_b = (_a = this.parentElement) === null || _a === void 0 ? void 0 : _a.getBoundingClientRect()) === null ||
          _b === void 0
            ? void 0
            : _b.top) -
          ((_c = this.shadowRoot.querySelector('.period-picker-wrap')) === null || _c === void 0
            ? void 0
            : _c.clientHeight) -
          25
      );
  ...
  _optionMonthClickHandler(e) {
    ...
    if (this.shadowRoot.querySelector('.period-month.period .select') === null) {
      ...
      if (this._startMonth < Number($el.dataset.value) && this._endMonth === undefined) {
        ...
        (_a = this.shadowRoot.querySelector('.period-month.period .select')) === null || _a === void 0
          ? void 0
          : _a.classList.add('select-start');
        ...
        (_b = this.shadowRoot.querySelector('.period-month.period .select')) === null || _b === void 0
          ? void 0
          : _b.classList.remove('select');
        (_c = this.shadowRoot.querySelector('.period-month.period .select')) === null || _c === void 0
          ? void 0
          : _c.classList.remove('select');
        (_d = this.shadowRoot.querySelector('.period-month.period .select-start')) === null || _d === void 0
          ? void 0
          : _d.classList.remove('select-start');
        (_e = this.shadowRoot.querySelector('.period-month.period .select-end')) === null || _e === void 0
          ? void 0
          : _e.classList.remove('select-end');
        (_f = this.shadowRoot.querySelectorAll('.period-month.period .select-period')) === null || _f === void 0
          ? void 0
          : _f.forEach($period => {
              $period.classList.remove('select-period');
            });
  ...
  _monthSelect() {
    ...
    (_a = $el === null || $el === void 0 ? void 0 : $el.querySelector('.select')) === null || _a === void 0
      ? void 0
      : _a.classList.remove('select');
  ...
  _daySelect() {
    ...
    (_e = $el.querySelectorAll('.select-period')) === null || _e === void 0
      ? void 0
      : _e.forEach($period => {
          let _a;
          (_a = $period === null || $period === void 0 ? void 0 : $period.classList) === null || _a === void 0
            ? void 0
            : _a.remove('select-period');
        });
...
__decorate([property({ type: String }), __metadata('design:type', Object)], Periodpicker.prototype, 'value', void 0);
__decorate(
...
__decorate([property({ type: String }), __metadata('design:type', Object)], Periodpicker.prototype, 'min', void 0);
__decorate([property({ type: String }), __metadata('design:type', Object)], Periodpicker.prototype, 'max', void 0);
__decorate([property({ type: String }), __metadata('design:type', Object)], Periodpicker.prototype, 'end', void 0);
__decorate([property({ type: String }), __metadata('design:type', Object)], Periodpicker.prototype, 'start', void 0);
__decorate([internalProperty(), __metadata('design:type', Object)], Periodpicker.prototype, '_value', void 0);
__decorate([internalProperty(), __metadata('design:type', Object)], Periodpicker.prototype, 'height', void 0);
__decorate([internalProperty(), __metadata('design:type', Object)], Periodpicker.prototype, 'inputValue', void 0);
__decorate([internalProperty(), __metadata('design:type', Object)], Periodpicker.prototype, 'active', void 0);
__decorate(
  [internalProperty(), __metadata('design:type', TemplateResult)],
  Periodpicker.prototype,
  '_beforeView',
  void 0
);
...
__decorate([internalProperty(), __metadata('design:type', TemplateResult)], Periodpicker.prototype, '_nowView', void 0);
__decorate([internalProperty(), __metadata('design:type', String)], Periodpicker.prototype, 'mode', void 0);
